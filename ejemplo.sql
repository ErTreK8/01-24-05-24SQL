...
CREATE TABLE IF NOT EXISTS Alumne(
	...
	CONSTRAINT fk_alumne_cicleFormatiu FOREIGN KEY(cicleFormatiuCodi) 
		REFERENCES CicleFormatiu(codi)
...
INSERT INTO
 CicleFormatiu VALUES ('AIF','Finances',2000);
SAVEPOINT A;
...
UPDATE CicleFormatiu SET  codi = 'DAW' WHERE codi ='DAM';
INSERT INTO CicleFormatiu VALUES ('FAR','Medicina',2000);
INSERT INTO Alumne VALUES ('DNI10','Verónica Martín',3,'FAR');
INSERT INTO Alumne VALUES ('DNI9','Sandra Navarro',2,'FAR');
DELETE FROM CicleFormatiu WHERE codi = 'DAW';
COMMIT;
-- *****************   TRAM 5 *****************
SELECT * FROM Alumne;  
SELECT * FROM CicleFormatiu;	
